	...
	return (
		<div className="h-screen flex flex-col items-center justify-center">
			<form onSubmit={handleSubmit(onSubmit)} className="bg-white p-8 rounded-lg shadow-md w-96">
				...
				<div className="mt-4">
					<span className="text-gray-600 text-xs">新規登録はこちら</span>
					<Link href={"/auth/register"} className="text-blue-500 text-xs font-bold ml-1 hover:text-blue-700">新規登録ページへ</Link>
				</div>
			</form>
		</div>
	)
